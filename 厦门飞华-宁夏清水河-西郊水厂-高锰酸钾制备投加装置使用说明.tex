...
\section{系统组成及功能说明}
   ...
   \par也可以参考在线三维模型{\url{http://119.45.100.78/2022-Ningxia-Qingshuihe-KMnO4-M155/KMnO4.html}}。
   在线三维模型加载需要一定时间。
   \subsection{系统构成图}
...
\section{设备启动前准备}\label{sec:sg1}
   ...
   \subsection{检查系统中各阀门状态}
      ...
      \begin{figure}[h]
         ...
         \begin{tikzpicture}
            %图片
            \node at (0,0) {\includegraphics[height=13cm]{g02.PNG}};
...
\newpage
      ...
      \begin{figure}[h]
         ...
         \begin{tikzpicture}
            %图片
            \node at (0,0) {\includegraphics[height=12cm]{g05.PNG}};
   ...
   \subsection{成品投加控制}
      ...
      \begin{figure}[h]
         \centering
            \begin{tikzpicture}
               %图片
               \node at (0,0) {\includegraphics[height=8cm]{g3.PNG}};
   ...
   \subsection{溶液制备控制}
      ...
      \begin{figure}[h]
         \centering
            \begin{tikzpicture}
               %图片
               \node at (0,0) {\includegraphics[height=8cm]{g20.PNG}};
         ...
         上显示料斗物位的位置。
          ...
          \begin{figure}[h]
             \centering
               \begin{tikzpicture}
                  %图片
                  \node at (0,0) {\includegraphics[height=7cm]{g2.PNG}};
   ...
   \subsection{制备系统的检修维护}
        ...
        \subsubsection{控制方式设为手动} 
          ...
          \begin{figure}[h]
             \centering
                \begin{tikzpicture}
                   %图片
                   \node at (0,0) {\includegraphics[height=8cm]{g21.PNG}};
        ...
        \subsubsection{传感器及电动阀的检修维护} 
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}
                    %图片
                    \node at (0,0) {\includegraphics[height=8cm]{g06.PNG}};
        ...
        \subsubsection{搅拌机及螺旋进料器检修维护}
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}
                    %图片
                    \node  at (0,0) {\includegraphics[height=10cm]{g01.PNG}};
   ...
   \subsection{投加系统的检修维护}
        ...
        \subsubsection{关闭供药阀}
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}
                    %图片
                    \node at (0,0) {\includegraphics[height=9cm]{g07.PNG}};

                    %说明
                    \node at (3,5) (1) [text_box] {供药阀};
                    \draw [arrow] (1) -- (3.8,3);
                    \draw (3.8,3) circle (0.5)[red];
                    \node at (3,-5) (2) [text_box] {供药阀};
                    \draw [arrow] (2) -- (3.8,0);
                    \draw (3.8,0) circle (0.5)[red];
        ...
        \subsubsection{关闭相应工位的加药阀}
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}
                    %图片
                    \node at (0,0) {\includegraphics[height=10cm]{g05.PNG}};

                    %说明
                    \node at (-6,2) (1) [text_box] {加药阀};
                    \draw [arrow] (1) -- (-1.5,-0.1);
                    \draw (-1.5,-0.1) circle (0.5)[red];
                    \node at (6,2) (2) [text_box] {加药阀};
                    \draw [arrow] (2) -- (1.0,0);
                    \draw (1.0,0) circle (0.5)[red];
                    \node at (-6,-1) (3) [text_box] {排液阀};
                    \draw [arrow] (3) -- (-1,-2.7);
                    \draw (-1,-2.7) circle (0.5)[red];
                    \node at (6,-1) (4) [text_box] {排液阀};
                    \draw [arrow] (4) -- (1.5,-2.7);
                    \draw (1.5,-2.7) circle (0.5)[red];
